...
class MajorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $majors = array(
            ...
            array('code' => '3', 'name' => 'INTERIOR PRODUCT DESIGN',                             'english_name' => 'INTERIOR PRODUCT DESIGN',                                'faculty_id' => Faculty::where('code', 'E')->first()->id),
            array('code' => '3', 'name' => 'INTERIOR DESIGN AND STYLING',                         'english_name' => 'INTERIOR DESIGN AND STYLING',                            'faculty_id' => Faculty::where('code', 'E')->first()->id),
            array('code' => '4', 'name' => 'DESAIN KOMUNIKASI VISUAL',                            'english_name' => 'VISUAL COMMUNICATION DESIGN',                            'faculty_id' => Faculty::where('code', 'E')->first()->id),
            array('code' => '4', 'name' => 'TEXTILE AND FASHION DESIGN',                          'english_name' => 'TEXTILE AND FASHION DESIGN',                             'faculty_id' => Faculty::where('code', 'E')->first()->id),
            array('code' => '4', 'name' => 'INTERNATIONAL PROGRAM IN DIGITAL MEDIA',              'english_name' => 'INTERNATIONAL PROGRAM IN DIGITAL MEDIA',                 'faculty_id' => Faculty::where('code', 'E')->first()->id),
