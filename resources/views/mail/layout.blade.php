    ...
    <div class="content__container">
        <div class="content__header">
            <div class="content__header__logo">
                <a href="wgg.petra.ac.id" target="_blank">
                    <img src="https://wgg.petra.ac.id/wgg23/assets/images/wgg.png" alt="Welcome Grateful Generation" class="header-bureau-logo" width="100px;">
                </a>
            </div>
        </div>
